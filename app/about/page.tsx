    ...
    <div className="pt-20 bg-[#1a1a00]">
      ...
      <section className="section-padding">
        <div className="container mx-auto px-6 max-w-5xl text-center">
          <p className="text-sm tracking-[0.3em] text-amber-600 mb-6">私たちについて</p>
          ...
          <div className="w-full max-w-[1000px] mx-auto">
            ...
            <p className="text-xl text-amber-900 leading-relaxed font-light text-justify [text-justify:inter-ideograph] break-all w-full">
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                <p className="text-sm tracking-[0.3em] text-amber-600 mb-4">理念</p>
                <h2 className="font-display text-4xl font-medium text-amber-950 mb-6">
                  使命
                </h2>
                <div className="divider-line mx-0 mb-8 bg-amber-200"></div>
              </div>
            ...
            <div className="relative">
              <div className="washi-card p-12 space-y-8 bg-white/60 border border-amber-200/40 rounded-sm shadow-lg">
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    <div className="w-2 h-2 bg-amber-600 rounded-full"></div>
                    <h3 className="font-display text-xl font-medium text-amber-950">誠実</h3>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    <div className="w-2 h-2 bg-amber-600 rounded-full"></div>
                    <h3 className="font-display text-xl font-medium text-amber-950">研鑽</h3>
                  </div>
                  <p className="text-amber-800 leading-relaxed font-light pl-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    <div className="w-2 h-2 bg-amber-600 rounded-full"></div>
                    <h3 className="font-display text-xl font-medium text-amber-950">共創</h3>
                  </div>
                  <p className="text-amber-800 leading-relaxed font-light pl-6">
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center space-y-6">
              <div className="w-24 h-24 mx-auto border border-amber-300 rounded-sm flex items-center justify-center">
                <span className="font-display text-3xl text-amber-600">簡</span>
              </div>
              <h3 className="font-display text-2xl font-medium text-amber-950">洗練された簡潔さ</h3>
            ...
            <div className="text-center space-y-6">
              <div className="w-24 h-24 mx-auto border border-amber-300 rounded-sm flex items-center justify-center">
                <span className="font-display text-3xl text-amber-600">和</span>
              </div>
              <h3 className="font-display text-2xl font-medium text-amber-950">伝統と革新の調和</h3>
              <p className="text-amber-800 leading-relaxed font-light">
            ...
            <div className="text-center space-y-6">
              <div className="w-24 h-24 mx-auto border border-amber-300 rounded-sm flex items-center justify-center">
                <span className="font-display text-3xl text-amber-600">心</span>
              </div>
              <h3 className="font-display text-2xl font-medium text-amber-950">真心を込めた手仕事</h3>
              <p className="text-amber-800 leading-relaxed font-light">
      ...
      <section className="section-padding bg-gradient-to-b from-amber-50/30 to-white">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-20">
            <p className="text-sm tracking-[0.3em] text-amber-600 mb-4">歩み</p>
            <h2 className="font-display text-4xl font-medium text-amber-950 mb-6">
              歩み
            </h2>
            <div className="divider-line bg-amber-200"></div>
          ...
          <div className="space-y-16">
            <div className="flex gap-12 items-start">
              <div className="flex-shrink-0 w-32 text-right">
                <span className="font-display text-3xl font-medium text-amber-600">2015</span>
              </div>
              <div className="flex-1 pt-2 border-l-2 border-amber-200 pl-8">
                <h3 className="font-display text-xl font-medium text-amber-950 mb-3">修業の始まり</h3>
                <p className="text-amber-800 leading-relaxed font-light">
            ...
            <div className="flex gap-12 items-start">
              <div className="flex-shrink-0 w-32 text-right">
                <span className="font-display text-3xl font-medium text-amber-600">2018</span>
              </div>
              <div className="flex-1 pt-2 border-l-2 border-amber-200 pl-8">
                <h3 className="font-display text-xl font-medium text-amber-950 mb-3">独自スタイルの確立</h3>
                <p className="text-amber-800 leading-relaxed font-light">
            ...
            <div className="flex gap-12 items-start">
              <div className="flex-shrink-0 w-32 text-right">
                <span className="font-display text-3xl font-medium text-amber-600">2021</span>
              </div>
              <div className="flex-1 pt-2 border-l-2 border-amber-200 pl-8">
                <h3 className="font-display text-xl font-medium text-amber-950 mb-3">HuyK Jewelry 工房設立</h3>
                <p className="text-amber-800 leading-relaxed font-light">
            ...
            <div className="flex gap-12 items-start">
              <div className="flex-shrink-0 w-32 text-right">
                <span className="font-display text-3xl font-medium text-amber-600">現在</span>
              </div>
              <div className="flex-1 pt-2 pl-8">
                <h3 className="font-display text-xl font-medium text-amber-950 mb-3">未来へ</h3>
                <p className="text-amber-800 leading-relaxed font-light">
      ...
      {/* <section className="section-padding">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          <div className="washi-card p-16 space-y-8">
            <p className="font-display text-3xl md:text-4xl text-amber-950 leading-relaxed">
              「一期一会」
            </p>
            <div className="divider-line bg-amber-200"></div>
            <p className="text-amber-800 leading-relaxed font-light">
