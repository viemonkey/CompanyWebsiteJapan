...
export const translations: Record<string, Record<string, any>> = {
  en: {
    ...
    title: {titleSS3: "THE SHOKUNIN SPIRIT"},
    ...
    products: {
      silver: { label: "S925 Silver", title: "Invisibility Ring", desc: "Crafted from pure S925 silver, carrying protective energy and prosperity." },
    ...
    team: {
      heroLabel: "Crafting Excellence", heroTitle: "The Souls Behind", heroTitleHighlight: "Every Creation", gridLabel: "The Master Hands", gridTitle: "The souls behind every creation", seeMore: "See more", expertiseLabel: "Areas of Expertise", footer: "© 2026 VIEN CHI BAO GLOBAL LLC. THE ARTISAN ARCHIVE.", members: [
  ...
  vi: {
    ...
    products: {
      silver: { label: "Bạc S925", title: "Nhẫn tàng hình", desc: "Chế tác từ bạc S925 nguyên chất, mang năng lượng bảo hộ và tài lộc." },
    ...
    about: { heroLabel: "Nghệ Nhân Bậc Thầy Viên Chi Bảo", heroTitle: "Đôi Bàn Tay", heroTitleHighlight: "Chạm Đến Linh Hồn", heroQuote: '"Mỗi kiệt tác kể một câu chuyện độc đáo, gửi gắm niềm tin và những giá trị tâm linh sâu sắc cho khách hàng quý mến."', missionLabel: "Nghệ Nhân HuyK", missionTitle: "Sứ Mệnh Của Chúng Tôi", missionP1: "HuyK là một thợ kim hoàn bậc thầy với hơn một thập kỷ kinh nghiệm.", missionP2: 'Được đào tạo bởi các bậc thầy Nhật Bản, tôi kế thừa tinh thần "Shokunin".', philosophyLabel: "Triết Lý Của Chúng Tôi", philosophyTitle: "Những Trụ Cột Của Nghề Thủ Công Bậc Thầy", pillars: [{ title: "Chính Trực", desc: "Hoàn toàn minh bạch về chất lượng và trọng lượng vàng bạc." }, { title: "An Toàn", desc: "Sử dụng vật liệu sạch, không niken, an toàn cho mọi loại da." }, { title: "Nghệ Thuật", desc: "Mỗi sản phẩm là một kiệt tác thủ công." }, { title: "Tâm Hồn", desc: "Truyền tải linh hồn và năng lượng tích cực vào từng thiết kế." }], footer: "© 2026 VIÊN CHI BẢO GLOBAL LLC. HÀNH TRÌNH NGHỆ NHÂN." },
    team: {
      heroLabel: "Tinh Hoa Chế Tác", heroTitle: "Những Tâm Hồn Đằng Sau", heroTitleHighlight: "Mỗi Sáng Tạo", gridLabel: "Đôi Bàn Tay Bậc Thầy", gridTitle: "Những tâm hồn đằng sau mỗi sáng tạo", seeMore: "Xem thêm", expertiseLabel: "Lĩnh Vực Chuyên Môn", footer: "© 2026 VIÊN CHI BẢO GLOBAL LLC. KHO LƯU TRỮ NGHỆ NHÂN.", members: [
  ...
  ja: {
    ...
    products: {
      silver: { label: "S925シルバー", title: "透明になれる指輪", desc: "純粋なS925シルバーで作られ、保護エネルギーと繁栄をもたらします。" },
  ...
  fr: {
    ...
    title: {titleSS3: "L'esprit Shokunin"},
    ...
    products: {
      silver: { label: "Argent S925", title: "Anneau d'invisibilité", desc: "Fabriqué en argent S925 pur, portant énergie protectrice et prospérité." },
    ...
    about: { heroLabel: "Maître Artisan Vien Chi Bao", heroTitle: "Les Mains Qui", heroTitleHighlight: "Façonnent l'Âme", heroQuote: '"Chaque chef-d\'œuvre raconte une histoire unique."', missionLabel: "Artisan HuyK", missionTitle: "Notre Mission", missionP1: "HuyK est un maître orfèvre avec plus d'une décennie d'expérience.", missionP2: 'Formé par des maîtres japonais, j\'ai hérité de l\'esprit "Shokunin".', philosophyLabel: "Notre Philosophie", philosophyTitle: "Les Piliers de la Maîtrise Artisanale", pillars: [{ title: "Intégrité", desc: "Transparence absolue concernant la qualité et le poids de l'or et de l'argent." }, { title: "Sécurité", desc: "Utilisation de matériaux propres, sans nickel, sûrs pour tous les types de peau." }, { title: "Artisanat", desc: "Chaque pièce est un chef-d'œuvre artisanal." }, { title: "Esprit", desc: "Infuser l'âme et l'énergie positive dans chaque design." }], footer: "© 2026 VIEN CHI BAO GLOBAL LLC. LE VOYAGE ARTISANAL." },
    team: {
      heroLabel: "Excellence Artisanale", heroTitle: "Les Âmes Derrière", heroTitleHighlight: "Chaque Création", gridLabel: "Les Mains Maîtresses", gridTitle: "Les âmes derrière chaque création", seeMore: "Voir plus", expertiseLabel: "Domaines d'Expertise", footer: "© 2026 VIEN CHI BAO GLOBAL LLC. LES ARCHIVES ARTISANALES.", members: [
  ...
  de: {
    ...
    title: {titleSS3: "Der Shokunin-Geist"},
    ...
    products: {
      silver: { label: "S925 Silber", title: "Unsichtbarkeitsring", desc: "Aus reinem S925 Silber gefertigt, trägt Schutzenergie und Wohlstand." },
  ...
  es: {
    ...
    title: {titleSS3: "El espíritu Shokunin"},
    ...
    products: {
      silver: { label: "Plata S925", title: "Anillo de invisibilidad", desc: "Elaborada en plata S925 pura, portando energía protectora y prosperidad." },
    ...
    about: { heroLabel: "Maestro Artesano Vien Chi Bao", heroTitle: "Las Manos Que", heroTitleHighlight: "Moldean el Alma", heroQuote: '"Cada obra maestra cuenta una historia única."', missionLabel: "Artesano HuyK", missionTitle: "Nuestra Misión", missionP1: "HuyK es un maestro orfebre con más de una década de experiencia.", missionP2: 'Formado por maestros japoneses, heredé el espíritu "Shokunin".', philosophyLabel: "Nuestra Filosofía", philosophyTitle: "Los Pilares de la Maestría Artesanal", pillars: [{ title: "Integridad", desc: "Transparencia absoluta sobre la calidad del oro y la plata." }, { title: "Seguridad", desc: "Materiales sin níquel, seguros para todo tipo de piel." }, { title: "Artesanía", desc: "Cada pieza es una obra maestra artesanal." }, { title: "Espíritu", desc: "Infundir alma y energía positiva en cada diseño." }], footer: "© 2026 VIEN CHI BAO GLOBAL LLC. EL VIAJE ARTESANAL." },
    team: {
      heroLabel: "Excelencia Artesanal", heroTitle: "Las Almas Detrás de", heroTitleHighlight: "Cada Creación", gridLabel: "Las Manos Maestras", gridTitle: "Las almas detrás de cada creación", seeMore: "Ver más", expertiseLabel: "Áreas de Expertise", footer: "© 2026 VIEN CHI BAO GLOBAL LLC. EL ARCHIVO ARTESANAL.", members: [
  ...
  ko: {
    ...
    products: {
      silver: { label: "S925 실버", title: "투명 반지", desc: "순수 S925 실버로 제작되어 보호 에너지와 번영을 담고 있습니다." },
    ...
    about: { heroLabel: "마스터 장인 Vien Chi Bao", heroTitle: "영혼을 빚는", heroTitleHighlight: "장인의 손", heroQuote: '"각 걸작은 독특한 이야기를 전합니다."', missionLabel: "장인 HuyK", missionTitle: "우리의 사명", missionP1: "HuyK는 10년 이상의 경험을 가진 마스터 금세공사입니다.", missionP2: '일본 장인들에게 사사하여 "쇼쿠닌" 정신을 이어받았습니다.', philosophyLabel: "우리의 철학", philosophyTitle: "마스터 공예의 기둥", pillars: [{ title: "진실성", desc: "금은의 품질과 무게에 관한 완전한 투명성." }, { title: "안전성", desc: "모든 피부 타입에 안전한 니켈 프리 소재 사용." }, { title: "예술성", desc: "각 작품은 정밀하게 단조된 수공예 걸작." }, { title: "정신성", desc: "모든 디자인에 영혼과 긍정적인 에너지 주입." }], footer: "© 2026 VIEN CHI BAO GLOBAL LLC. 장인의 여정." },
    team: {
      heroLabel: "탁월한 공예", heroTitle: "모든 창조 뒤에 있는", heroTitleHighlight: "영혼들", gridLabel: "마스터의 손", gridTitle: "모든 창조 뒤에 있는 영혼들", seeMore: "더 보기", expertiseLabel: "전문 분야", footer: "© 2026 VIEN CHI BAO GLOBAL LLC. 장인 아카이브.", members: [
  ...
  th: {
    ...
    title: {titleSS3: "จิตวิญญาณแห่งโชคุนิน"},
    ...
    products: {
      silver: { label: "เงิน S925", title: "แหวนล่องหน", desc: "ทำจากเงิน S925 บริสุทธิ์ มอบพลังงานปกป้องและความเจริญรุ่งเรือง" },
