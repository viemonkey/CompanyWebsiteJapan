...
export const translations: Record<string, Record<string, any>> = {
  ...
  vi: {
    ...
    about: { heroLabel: "Nghệ Nhân Bậc Thầy Viên Chi Bảo", heroTitle: "Đôi Bàn Tay", heroTitleHighlight: "Chạm Đến Linh Hồn", heroQuote: '"Mỗi kiệt tác kể một câu chuyện độc đáo, gửi gắm niềm tin và những giá trị tâm linh sâu sắc cho khách hàng quý mến."', missionLabel: "Nghệ Nhân HuyK", missionTitle: "Sứ Mệnh Của Chúng Tôi", missionP1: "HuyK là một thợ kim hoàn bậc thầy với hơn một thập kỷ kinh nghiệm, được thúc đẩy bởi niềm đam mê sâu sắc với trang sức thủ công. Hành trình của tôi bắt đầu với sự ám ảnh về những chi tiết tinh xảo nhất.", missionP2: 'Được đào tạo bởi các bậc thầy Nhật Bản, tôi kế thừa tinh thần "Shokunin" — sự theo đuổi hoàn hảo không ngừng nghỉ và cống hiến tuyệt đối cho nghề. Triết lý này đã trở thành nền tảng của xưởng thủ công của tôi tại Việt Nam.', philosophyLabel: "Triết Lý Của Chúng Tôi", philosophyTitle: "Những Trụ Cột Của Nghề Thủ Công Bậc Thầy", pillars: [{ title: "Chính Trực", desc: "Hoàn toàn minh bạch về chất lượng và trọng lượng vàng bạc." }, { title: "An Toàn", desc: "Sử dụng vật liệu sạch, không niken, an toàn cho mọi loại da." }, { title: "Nghệ Thuật", desc: "Mỗi sản phẩm là một kiệt tác thủ công, được rèn giũa tỉ mỉ với độ chính xác cao." }, { title: "Tâm Hồn", desc: "Truyền tải linh hồn và năng lượng tích cực vào từng thiết kế." }], footer: "© 2026 VIÊN CHI BẢO GLOBAL LLC. HÀNH TRÌNH NGHỆ NHÂN." },
    team: { heroLabel: "Tinh Hoa Chế Tác", heroTitle: "Những Tâm Hồn Đằng Sau", heroTitleHighlight: "Mỗi Sáng Tạo", gridLabel: "Đôi Bàn Tay Bậc Thầy", gridTitle: "Những tâm hồn đằng sau mỗi sáng tạo", seeMore: "Xem thêm", expertiseLabel: "Lĩnh Vực Chuyên Môn", footer: "© 2026 VIÊN CHI BẢO GLOBAL LLC. KHO LƯU TRỮ NGHỆ NHÂN.", members: [
      ...
      { name: "Quoc Anh", position: "Nghệ Nhân Cao Cấp", bio: "Chuyên về gia công chính xác cao. Bậc thầy về chạm khắc tinh xảo.", expertise: ["Gắn Đá", "Hoàn Thiện"] },
      { name: "Minh Tu", position: "Nghệ Nhân Cao Cấp", bio: "Chuyên về gia công chính xác cao. Chuyên gia phục hồi tác phẩm cổ.", expertise: ["Gắn Đá", "Hoàn Thiện"] },
      { name: "Hoang Nam", position: "Nghệ Nhân Cao Cấp", bio: "Chuyên về gia công chính xác cao. Tập trung vào sự thuần khiết năng lượng của đá quý.", expertise: ["Gắn Đá", "Hoàn Thiện"] },
    ]},
    products: { heroLabel: "Hậu Cần & Giao Hàng Toàn Cầu", heroTitle: "Chính Sách", heroTitleHighlight: "Vận Chuyển", intro: '"Tại VienChiBao, chúng tôi hiểu rằng mỗi món trang sức mang ý nghĩa và tình cảm sâu sắc. Đội ngũ của chúng tôi cam kết đảm bảo món hàng của bạn được giao nhanh chóng, an toàn và trong tình trạng hoàn hảo."', deliveryLabel: "Giao Hàng", deliveryTitle: "Miễn Phí Vận Chuyển", deliveryDesc: "Chúng tôi vui lòng cung cấp dịch vụ vận chuyển miễn phí cho tất cả đơn hàng trong nước và quốc tế.", timelineLabel: "Thời Gian", timelineTitle: "Chế Tác & Xử Lý", timelineP1: "Thời gian xử lý ước tính:", timelineHighlight: "1 đến 3 tuần", timelineP2: "Có thể hủy hoặc điều chỉnh trước khi bắt đầu quá trình chế tác cuối cùng.", securityLabel: "Bảo Mật", securityTitle: "Theo Dõi Đơn Hàng & Bảo Mật", securityP1: "Sau khi giao hàng, bạn sẽ nhận được mã theo dõi qua email. Vui lòng đảm bảo địa chỉ giao hàng và thông tin liên hệ chính xác.", securityList: ["Kiểm tra ban quản lý tòa nhà hoặc hộp thư an toàn.", "Xác nhận với hàng xóm hoặc thành viên trong gia đình.", "Liên hệ với đơn vị vận chuyển địa phương để xác minh chữ ký."] },
  },
  ...
  ja: {
    ...
    about: { heroLabel: "マスター職人 Vien Chi Bao", heroTitle: "魂を形にする", heroTitleHighlight: "匠の手", heroQuote: '「各傑作はユニークな物語を語り、大切なお客様への信仰と深い精神的価値を込めています。」', missionLabel: "職人 HuyK", missionTitle: "私たちの使命", missionP1: "HuyKは10年以上の経験を持つ金細工師で、手作りジュエリーへの深い情熱に突き動かされています。私の旅は最も繊細な細部へのこだわりから始まりました。", missionP2: '日本の匠に師事し、「職人」精神――完璧への絶え間ない追求と工芸への揺るぎない献身を受け継ぎました。この哲学はベトナムの私のアトリエの礎となっています。', philosophyLabel: "私たちの哲学", philosophyTitle: "マスター工芸の柱", pillars: [{ title: "誠実さ", desc: "金銀の品質と重量に関する完全な透明性。" }, { title: "安全性", desc: "あらゆる肌タイプに安全なニッケルフリーの清潔な素材を使用。" }, { title: "芸術性", desc: "各作品は精密に鍛造された手作りの傑作。" }, { title: "精神性", desc: "すべてのデザインに魂とポジティブなエネルギーを注入。" }], footer: "© 2026 VIEN CHI BAO GLOBAL LLC. 職人の旅。" },
    ...
    products: { heroLabel: "物流 & グローバル配送", heroTitle: "配送", heroTitleHighlight: "ポリシー", intro: '「VienChiBaoでは、すべてのジュエリーが深い意味と感情を持つことを理解しています。私たちのチームは、お客様のお品物を迅速、安全、完璧な状態でお届けすることをお約束します。」', deliveryLabel: "配送", deliveryTitle: "送料無料", deliveryDesc: "国内外すべてのご注文に無料配送サービスを提供しています。", timelineLabel: "タイムライン", timelineTitle: "制作 & 取り扱い", timelineP1: "推定処理時間：", timelineHighlight: "1〜3週間", timelineP2: "最終制作プロセス開始前はキャンセルや調整が可能です。", securityLabel: "セキュリティ", securityTitle: "注文追跡 & セキュリティ", securityP1: "発送後、追跡番号をメールでお知らせします。配送先住所と連絡先情報が正確であることをご確認ください。", securityList: ["建物管理または安全な郵便受けを確認してください。", "隣人や家族に確認してください。", "署名確認のため地元の配送業者に連絡してください。"] },
  },
  ...
  fr: {
    ...
    about: { heroLabel: "Maître Artisan Vien Chi Bao", heroTitle: "Les Mains Qui", heroTitleHighlight: "Façonnent l'Âme", heroQuote: '"Chaque chef-d\'œuvre raconte une histoire unique, incarnant la foi et de profondes valeurs spirituelles pour nos précieux clients."', missionLabel: "Artisan HuyK", missionTitle: "Notre Mission", missionP1: "HuyK est un maître orfèvre avec plus d'une décennie d'expérience, animé par une profonde passion pour la bijouterie artisanale. Mon voyage a commencé avec une obsession pour les détails les plus fins.", missionP2: 'Formé par des maîtres japonais, j\'ai hérité de l\'esprit "Shokunin" — la poursuite incessante de la perfection et un dévouement indéfectible au métier. Cette philosophie est devenue la pierre angulaire de mon atelier au Vietnam.', philosophyLabel: "Notre Philosophie", philosophyTitle: "Les Piliers de la Maîtrise Artisanale", pillars: [{ title: "Intégrité", desc: "Transparence absolue concernant la qualité et le poids de l'or et de l'argent." }, { title: "Sécurité", desc: "Utilisation de matériaux propres, sans nickel, sûrs pour tous les types de peau." }, { title: "Artisanat", desc: "Chaque pièce est un chef-d'œuvre artisanal, forgé méticuleusement avec précision." }, { title: "Esprit", desc: "Infuser l'âme et l'énergie positive dans chaque design." }], footer: "© 2026 VIEN CHI BAO GLOBAL LLC. LE VOYAGE ARTISANAL." },
    team: { heroLabel: "Excellence Artisanale", heroTitle: "Les Âmes Derrière", heroTitleHighlight: "Chaque Création", gridLabel: "Les Mains Maîtresses", gridTitle: "Les âmes derrière chaque création", seeMore: "Voir plus", expertiseLabel: "Domaines d'Expertise", footer: "© 2026 VIEN CHI BAO GLOBAL LLC. LES ARCHIVES ARTISANALES.", members: [
      ...
      { name: "Linh Thi", position: "Directrice Artistique", bio: "Avec une sensibilité esthétique délicate, elle crée des designs qui donnent forme aux émotions les plus profondes.", expertise: ["Design de Bijoux", "Direction Créative"] },
      { name: "Thanh Minh", position: "Artisan Senior", bio: "Spécialisé dans la transformation de haute précision. Son dévouement aux détails garantit que chaque œuvre répond aux plus hauts standards.", expertise: ["Sertissage", "Finition"] },
    ...
    products: { heroLabel: "Logistique & Livraison Mondiale", heroTitle: "Politique de", heroTitleHighlight: "Livraison", intro: '"Chez VienChiBao, nous comprenons que chaque bijou porte une signification et un sentiment profonds. Notre équipe s\'engage à livrer vos pièces rapidement, en toute sécurité et en parfait état."', deliveryLabel: "Livraison", deliveryTitle: "Livraison Gratuite", deliveryDesc: "Nous sommes heureux d'offrir des services d'expédition gratuits pour toutes les commandes nationales et internationales.", timelineLabel: "Délais", timelineTitle: "Fabrication & Traitement", timelineP1: "Délai de traitement estimé :", timelineHighlight: "1 à 3 semaines", timelineP2: "Les annulations ou ajustements sont possibles avant le début du processus de fabrication final.", securityLabel: "Sécurité", securityTitle: "Suivi de Commande & Sécurité", securityP1: "Une fois expédié, vous recevrez un numéro de suivi par email. Veuillez vous assurer que votre adresse et vos coordonnées sont exactes.", securityList: ["Vérifiez la gestion de l'immeuble ou les boîtes aux lettres sécurisées.", "Confirmez avec les voisins ou les membres du foyer.", "Contactez le transporteur local pour vérification de signature."] },
  },
  ...
  de: {
    ...
    about: { heroLabel: "Meister-Handwerker Vien Chi Bao", heroTitle: "Die Hände, die", heroTitleHighlight: "die Seele formen", heroQuote: '"Jedes Meisterwerk erzählt eine einzigartige Geschichte und verkörpert Glauben und tiefe spirituelle Werte für unsere geschätzten Kunden."', missionLabel: "Handwerker HuyK", missionTitle: "Unsere Mission", missionP1: "HuyK ist ein Meister-Goldschmied mit über einem Jahrzehnt Erfahrung, getrieben von einer tiefen Leidenschaft für handgefertigten Schmuck.", missionP2: 'Von japanischen Meistern ausgebildet, erbte ich den „Shokunin"-Geist — das unermüdliche Streben nach Perfektion und unerschütterliche Hingabe an das Handwerk.', philosophyLabel: "Unsere Philosophie", philosophyTitle: "Die Säulen des Meister-Handwerks", pillars: [{ title: "Integrität", desc: "Absolute Transparenz hinsichtlich Qualität und Gewicht von Gold und Silber." }, { title: "Sicherheit", desc: "Verwendung sauberer, nickelfreier Materialien, die für alle Hauttypen sicher sind." }, { title: "Kunstfertigkeit", desc: "Jedes Stück ist ein handgefertigtes Meisterwerk, sorgfältig mit Präzision geschmiedet." }, { title: "Geist", desc: "Einbringen von Seele und positiver Energie in jedes Design." }], footer: "© 2026 VIEN CHI BAO GLOBAL LLC. DIE HANDWERKER-REISE." },
    ...
    products: { heroLabel: "Logistik & Globale Lieferung", heroTitle: "Versand-", heroTitleHighlight: "Richtlinie", intro: '"Bei VienChiBao verstehen wir, dass jedes Schmuckstück tiefe Bedeutung trägt. Unser Team verpflichtet sich, Ihre Stücke schnell, sicher und in einwandfreiem Zustand zu liefern."', deliveryLabel: "Lieferung", deliveryTitle: "Kostenloser Versand", deliveryDesc: "Wir bieten kostenlose Versanddienste für alle nationalen und internationalen Bestellungen an.", timelineLabel: "Zeitplan", timelineTitle: "Fertigung & Bearbeitung", timelineP1: "Geschätzte Bearbeitungszeit:", timelineHighlight: "1 bis 3 Wochen", timelineP2: "Stornierungen oder Anpassungen sind vor Beginn des endgültigen Fertigungsprozesses möglich.", securityLabel: "Sicherheit", securityTitle: "Bestellverfolgung & Sicherheit", securityP1: "Nach dem Versand erhalten Sie eine Sendungsverfolgungsnummer per E-Mail. Bitte stellen Sie sicher, dass Ihre Lieferadresse korrekt ist.", securityList: ["Prüfen Sie die Gebäudeverwaltung oder sichere Briefkästen.", "Bestätigen Sie mit Nachbarn oder Haushaltsmitgliedern.", "Kontaktieren Sie den lokalen Kurier zur Signaturverifizierung."] },
  },
  ...
  es: {
    ...
    about: { heroLabel: "Maestro Artesano Vien Chi Bao", heroTitle: "Las Manos Que", heroTitleHighlight: "Moldean el Alma", heroQuote: '"Cada obra maestra cuenta una historia única, incorporando fe y profundos valores espirituales para nuestros queridos clientes."', missionLabel: "Artesano HuyK", missionTitle: "Nuestra Misión", missionP1: "HuyK es un maestro orfebre con más de una década de experiencia, impulsado por una profunda pasión por la joyería artesanal.", missionP2: 'Formado por maestros japoneses, heredé el espíritu "Shokunin" — la búsqueda incesante de la perfección y la dedicación inquebrantable al oficio.', philosophyLabel: "Nuestra Filosofía", philosophyTitle: "Los Pilares de la Maestría Artesanal", pillars: [{ title: "Integridad", desc: "Transparencia absoluta sobre la calidad y el peso del oro y la plata." }, { title: "Seguridad", desc: "Uso de materiales limpios, sin níquel, seguros para todo tipo de piel." }, { title: "Artesanía", desc: "Cada pieza es una obra maestra artesanal, forjada meticulosamente con precisión." }, { title: "Espíritu", desc: "Infundir alma y energía positiva en cada diseño." }], footer: "© 2026 VIEN CHI BAO GLOBAL LLC. EL VIAJE ARTESANAL." },
    team: { heroLabel: "Excelencia Artesanal", heroTitle: "Las Almas Detrás de", heroTitleHighlight: "Cada Creación", gridLabel: "Las Manos Maestras", gridTitle: "Las almas detrás de cada creación", seeMore: "Ver más", expertiseLabel: "Áreas de Expertise", footer: "© 2026 VIEN CHI BAO GLOBAL LLC. EL ARCHIVO ARTESANAL.", members: [
      ...
      { name: "Thanh Minh", position: "Artesano Senior", bio: "Especializado en procesamiento de alta precisión. Su dedicación al detalle garantiza los más altos estándares.", expertise: ["Engaste", "Acabado"] },
    ...
    products: { heroLabel: "Logística & Entrega Global", heroTitle: "Política de", heroTitleHighlight: "Envío", intro: '"En VienChiBao, entendemos que cada joya lleva un significado y sentimiento profundo. Nuestro equipo se compromete a entregar sus piezas rápidamente, de forma segura y en perfecto estado."', deliveryLabel: "Entrega", deliveryTitle: "Envío Gratuito", deliveryDesc: "Nos complace ofrecer servicios de envío gratuito para todos los pedidos nacionales e internacionales.", timelineLabel: "Plazos", timelineTitle: "Fabricación & Manejo", timelineP1: "Tiempo de procesamiento estimado:", timelineHighlight: "1 a 3 semanas", timelineP2: "Las cancelaciones o ajustes son posibles antes de que comience el proceso de fabricación final.", securityLabel: "Seguridad", securityTitle: "Seguimiento de Pedidos & Seguridad", securityP1: "Una vez enviado, recibirá un número de seguimiento por email. Asegúrese de que su dirección de envío sea correcta.", securityList: ["Verifique la administración del edificio o buzones seguros.", "Confirme con vecinos o miembros del hogar.", "Contacte al mensajero local para verificación de firma."] },
  },
  ...
  ko: {
    ...
    about: { heroLabel: "마스터 장인 Vien Chi Bao", heroTitle: "영혼을 빚는", heroTitleHighlight: "장인의 손", heroQuote: '"각 걸작은 소중한 고객을 위한 믿음과 깊은 영적 가치를 담아 독특한 이야기를 전합니다."', missionLabel: "장인 HuyK", missionTitle: "우리의 사명", missionP1: "HuyK는 10년 이상의 경험을 가진 마스터 금세공사로 수공예 주얼리에 대한 깊은 열정으로 움직입니다.", missionP2: '일본 장인들에게 사사하여 "쇼쿠닌" 정신 — 완벽에 대한 끊임없는 추구와 공예에 대한 흔들리지 않는 헌신을 이어받았습니다.', philosophyLabel: "우리의 철학", philosophyTitle: "마스터 공예의 기둥", pillars: [{ title: "진실성", desc: "금은의 품질과 무게에 관한 완전한 투명성." }, { title: "안전성", desc: "모든 피부 타입에 안전한 니켈 프리 소재 사용." }, { title: "예술성", desc: "각 작품은 정밀하게 단조된 수공예 걸작." }, { title: "정신성", desc: "모든 디자인에 영혼과 긍정적인 에너지 주입." }], footer: "© 2026 VIEN CHI BAO GLOBAL LLC. 장인의 여정." },
    ...
    products: { heroLabel: "물류 & 글로벌 배송", heroTitle: "배송", heroTitleHighlight: "정책", intro: '"VienChiBao에서는 모든 주얼리가 깊은 의미를 담고 있음을 이해합니다. 우리 팀은 귀하의 제품을 신속하고 안전하게 완벽한 상태로 배송할 것을 약속합니다."', deliveryLabel: "배송", deliveryTitle: "무료 배송", deliveryDesc: "국내외 모든 주문에 무료 배송 서비스를 제공합니다.", timelineLabel: "일정", timelineTitle: "제작 & 처리", timelineP1: "예상 처리 시간:", timelineHighlight: "1~3주", timelineP2: "최종 제작 프로세스 시작 전 취소 또는 조정이 가능합니다.", securityLabel: "보안", securityTitle: "주문 추적 & 보안", securityP1: "발송 후 이메일로 추적 번호를 받게 됩니다. 배송 주소와 연락처 정보가 정확한지 확인해 주세요.", securityList: ["건물 관리실 또는 안전한 우편함을 확인하세요.", "이웃이나 가족에게 확인하세요.", "서명 확인을 위해 지역 배송업체에 연락하세요."] },
  },
  ...
  th: {
    ...
    about: { heroLabel: "ช่างฝีมือบรมครู Vien Chi Bao", heroTitle: "มือที่", heroTitleHighlight: "สัมผัสจิตวิญญาณ", heroQuote: '"ผลงานชิ้นเอกแต่ละชิ้นเล่าเรื่องราวอันเป็นเอกลักษณ์ ฝังความเชื่อและคุณค่าทางจิตวิญญาณอันลึกซึ้งให้กับลูกค้าผู้เป็นที่รักของเรา"', missionLabel: "ช่างฝีมือ HuyK", missionTitle: "พันธกิจของเรา", missionP1: "HuyK เป็นช่างทองบรมครูที่มีประสบการณ์มากกว่าทศวรรษ ขับเคลื่อนด้วยความหลงใหลอย่างลึกซึ้งในเครื่องประดับทำมือ", missionP2: 'ได้รับการฝึกฝนจากบรมครูชาวญี่ปุ่น สืบทอดจิตวิญญาณ "โชคุนิน" — การแสวงหาความสมบูรณ์แบบอย่างไม่หยุดยั้ง', philosophyLabel: "ปรัชญาของเรา", philosophyTitle: "เสาหลักของงานฝีมือบรมครู", pillars: [{ title: "ความซื่อสัตย์", desc: "ความโปร่งใสอย่างแท้จริงเกี่ยวกับคุณภาพและน้ำหนักของทองและเงิน" }, { title: "ความปลอดภัย", desc: "ใช้วัสดุสะอาดปราศจากนิกเกิล ปลอดภัยสำหรับทุกสภาพผิว" }, { title: "ศิลปะ", desc: "แต่ละชิ้นเป็นผลงานชิ้นเอกทำมือที่ถูกหลอมขึ้นอย่างพิถีพิถัน" }, { title: "จิตวิญญาณ", desc: "ใส่จิตวิญญาณและพลังงานบวกลงในทุกการออกแบบ" }], footer: "© 2026 VIEN CHI BAO GLOBAL LLC. การเดินทางของช่างฝีมือ" },
    ...
    products: { heroLabel: "โลจิสติกส์ & การจัดส่งทั่วโลก", heroTitle: "นโยบาย", heroTitleHighlight: "การจัดส่ง", intro: '"ที่ VienChiBao เราเข้าใจว่าเครื่องประดับแต่ละชิ้นมีความหมายและความรู้สึกลึกซึ้ง ทีมของเราให้คำมั่นว่าจะจัดส่งชิ้นงานของคุณอย่างรวดเร็ว ปลอดภัย และในสภาพที่สมบูรณ์แบบ"', deliveryLabel: "การจัดส่ง", deliveryTitle: "จัดส่งฟรี", deliveryDesc: "เรายินดีให้บริการจัดส่งฟรีสำหรับคำสั่งซื้อทั้งในประเทศและต่างประเทศ", timelineLabel: "ระยะเวลา", timelineTitle: "การผลิต & การจัดการ", timelineP1: "เวลาดำเนินการโดยประมาณ:", timelineHighlight: "1 ถึง 3 สัปดาห์", timelineP2: "สามารถยกเลิกหรือปรับเปลี่ยนได้ก่อนเริ่มกระบวนการผลิตขั้นสุดท้าย", securityLabel: "ความปลอดภัย", securityTitle: "การติดตามคำสั่งซื้อ & ความปลอดภัย", securityP1: "เมื่อจัดส่งแล้ว คุณจะได้รับหมายเลขติดตามทางอีเมล โปรดตรวจสอบให้แน่ใจว่าที่อยู่จัดส่งและข้อมูลติดต่อถูกต้อง", securityList: ["ตรวจสอบการจัดการอาคารหรือตู้ไปรษณีย์ที่ปลอดภัย", "ยืนยันกับเพื่อนบ้านหรือสมาชิกในครัวเรือน", "ติดต่อผู้ส่งสินค้าในพื้นที่เพื่อยืนยันลายเซ็น"] },
  },
};
...
export const LanguageProvider = ({ children }: { children: ReactNode }) => {
  // Bắt đầu với 'en', sau đó detect IP sau khi mount
  ...
  useEffect(() => {
    // Mỗi lần load trang: luôn detect IP, không đọc cache
  ...
  // Ẩn nội dung cho đến khi detect IP xong để tránh flash tiếng Anh
